...
// /**
//  * Configures the screen options for the bottom tab navigator.
//  * This includes hiding the header, customizing the tab bar style, and setting active/inactive icon colors.
//  *
//  * @param {object} param - The route object containing the current route name.
//  * @returns {BottomTabNavigationOptions} The configured screen options for the bottom tab navigator.
//  */
